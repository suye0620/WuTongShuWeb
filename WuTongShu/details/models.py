...
class Category(models.Model):
    ...
    index = models.IntegerField(default=1, verbose_name='品牌排序')
    ...
    banner = models.URLField(max_length=200, default='http://42.193.14.111/static/upload/tsxywts/banner6.jpg', verbose_name='品牌封面')
